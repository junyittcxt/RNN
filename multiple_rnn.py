...
def main():
    ...
    optparser.add_option("-d", "--dropout", default=0, help="DROPOUT")
    optparser.add_option("-l", "--learningrate", default=0.0001, help="LEARNING_RATE")
    optparser.add_option("-a", "--asset", default="SPY", help="TARGET_TO_PREDICT")
    optparser.add_option("-n", "--neurons", default="SPY", help="NEURONS")

    optparser.add_option("-g", "--gpu", default="0", help="GPU 0 or 1 (2080 or 1050)")
    ...
    #Parameters
    NROWS = 200000
    TARGET_TO_PREDICT = (opts.asset)

    SEQ_LEN = 60
    FUTURE_PERIOD_PREDICT = 3

    NUMLAYER = 1
    NEURONS = int(opts.neurons)
